...
file_path = f'logs/log_scratch_{formatted_time}.txt'
...
def train():
    ...
    if num_unfrozen1>0:
        ...
        if scheduler_diff.lower()=='steplr':
            scheduler_classifier = StepLR(optim_classifier, step_size=num_steplr, gamma=0.7)
    ...
    for epoch in range(num_epochs_phase1):
        ...
        if rank == 0:
            ...
            if num_unfrozen1>0:
                with open(f"logs/log_scratch_{formatted_time}.txt",'a') as f:
