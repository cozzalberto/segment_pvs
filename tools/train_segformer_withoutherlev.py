...
file_path = f'logs/seg_logs/log_{formatted_time}.txt'
...
# Define paths
train_images = "dataset/solardk_segformer/danish_without_herlev/gentofte_trainval/train/positive"
train_masks = "dataset/solardk_segformer/danish_without_herlev/gentofte_trainval/train/mask"
val_images = "dataset/solardk_segformer/danish_without_herlev/gentofte_trainval/val/positive"
val_masks = "dataset/solardk_segformer/danish_without_herlev/gentofte_trainval/val/mask"
...
training_args = TrainingArguments(
    output_dir = f"logs/segformer_finetuning2_withoutherlev_{formatted_time}",
    learning_rate=lr,
   ...
   # eval_steps=30,
    ...
    logging_dir =f'logs/seg_logs_withoutherlev_{formatted_time}',
