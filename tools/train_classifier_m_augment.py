...
trainset_filtered = CustomDataset(root_dir='dataset/danish_dataset1/gentofte_trainval/train', classes=['positive', 'negative'], transform=training_transform)
valset = CustomDataset(root_dir='dataset/danish_dataset1/gentofte_trainval/val', classes=['positive', 'negative'], transform = transform)
