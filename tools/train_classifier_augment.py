...
train_path = '/leonardo_work/PHD_cozzani/seg_solarbackup/dataset/danish_dataset2/danish_with_bbr_and_google/gentofte_trainval/train'
trainset_filtered = CustomDataset(root_dir='/leonardo_work/PHD_cozzani/seg_solarbackup/dataset/danish_dataset2/danish_with_bbr_and_google/gentofte_trainval/train', classes=['positive', 'negative'], transform=training_transform)
